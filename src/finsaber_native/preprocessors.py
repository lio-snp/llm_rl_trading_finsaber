...
from src.finsaber_native import config
from src.finsaber_native.yahoodownloader import YahooDownloader
...
class FeatureEngineer:
    ...
    def preprocess_data(self, df):
        ...
        # patched for causal use inside rolling-window evaluation:
        # keep forward-only information flow and never backfill from future rows.
    ...
    def clean_data(self, data):
        ...
        # patched from original FINSABER:
        # do not drop tickers based on future-wide missing close coverage.
        # we preserve the original rows and rely on forward-only filling later.
        # df = data.copy()
